...
namespace BlogApi.Mapper.AutoMapper
{
    public class Mapper : Application.Interfaces.AutoMapper.ICustomMapper
    {
        ...
        protected void Config<TDestination, TSource>(int depth = 5, string? ignore = null)
        {
            ...
            if(typePairs.Any(a=>a.DestinationType == typePair.DestinationType && a.SourceType == typePair.DestinationType) && ignore is null)
            {
                return;
            }
